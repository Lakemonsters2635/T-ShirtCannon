...
public final class Constants {
    ...
    // BUTTON CONSTANTS (With logitech controller)
    public final static int SHOOTER_BUTTON1 = 7; // 7 and 8 are the triggers
    public final static int SHOOTER_BUTTON2 = 8;
    public final static int ROTATION_BUTTON = 2; // A button
    ...
    public static final int id_RIGHTMOTOR1 = 16;
    public static final int id_RIGHTMOTOR2 = 17;
}
